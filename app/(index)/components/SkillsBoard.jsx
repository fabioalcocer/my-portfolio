...
function SkillsBoard () {
  return (
    ...
    >
      <h2 className='mx-auto flex w-max flex-col items-center pb-4 text-4xl font-bold leading-10 tracking-tighter dark:text-zinc-100 text-zinc-8000 sm:pb-8 md:mx-0 md:text-6xl lg:px-14'>
        Skills & Tools
