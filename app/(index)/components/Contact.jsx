  ...
  return (
    <div className='mt-16 flex flex-col gap-7 md:flex-row'>
      ...
      <form
        ...
        className='mx-auto max-w-2xl flex-1 rounded-xl border border-zinc-100 p-6 shadow-inner shadow-zinc-800 transition-shadow duration-500 hover:shadow-transparent dark:border-zinc-700/40 md:ml-5 md:mt-10'
      >
