    ...
    <Container>
      <div className='sm:px-8'>
        ...
        <div className='mx-auto flex max-w-7xl flex-col justify-between gap-5 md:flex-row lg:px-8'>
          <form
            action='POST'
            className='max-w-2xl flex-1 rounded-xl border border-zinc-100 p-6 shadow-inner shadow-zinc-800 transition-shadow duration-500 hover:shadow-transparent dark:border-zinc-700/40 md:p-8 lg:ml-6'
