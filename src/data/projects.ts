...
export const projects: Project[] = [
	{
		id: 11,
		name: "Propio Platform",
		stack: [
			{
				name: "Next.js",
				color: "dark:border-black-500/40",
			},
			{
				name: "React",
			...
			{
				name: "AWS",
				color: "dark:border-orange-400/40",
			},
		],
		description:
			"The first Bolivian e-commerce platform that truly does it all for you. Set up your store in minutes without writing a single line of code and automate the entire process: from payment processing to delivery.",
		img: "https://res.cloudinary.com/daobmfotr/image/upload/v1773693558/sducawciew4tpled0jko.webp",
		url: "https://propio-bo.web.app/",
		progress: false,
		date: "During 2025",
	},
	{
	...
	},
	{
		...
		description:
			"Application that allows you to visualize, search and add video games of all platforms and consoles, has infinite scroll, uses React query to manage the state from the server and zustand to manage the global state.",
