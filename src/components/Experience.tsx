    ...
    <div className="mb-5 mt-16 flex flex-col gap-7 md:px-8 lg:px-14">
      ...
      <main className="mx-auto flex flex-col gap-4">
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="relative max-w-max mx-auto mt-6 overflow-hidden rounded-xl bg-black px-28 py-6 ring-0 ring-offset-black will-change-transform focus:outline-none focus:ring-1"
        >
