    ...
    <div className="mb-5 mt-16 flex flex-col gap-7 md:px-8 lg:px-14">
      ...
      <main className="mx-auto flex flex-col gap-4">
        <div className="mx-auto flex flex-col gap-6 lg:flex-row">
          <div className="flex max-w-xl flex-1 flex-col rounded-2xl border border-indigo-400/70 p-6 shadow-inner transition-shadow duration-500 dark:border-zinc-700/40 dark:shadow-zinc-700/40 dark:hover:shadow-transparent md:gap-2">
            ...
            <p className="mt-2 text-sm text-zinc-100 dark:text-zinc-300/90 sm:text-base md:pl-1 md:text-base">
              The free bootcamp that adapts to you. Specialize in development
              regardless of your level of knowledge and experience, we will
          ...
          <div className="flex max-w-xl flex-1 flex-col rounded-2xl border border-indigo-400/70 p-6 shadow-inner transition-shadow duration-500 dark:border-zinc-700/40 dark:shadow-zinc-700/40 dark:hover:shadow-transparent md:gap-2">
            ...
            <ul className="mt-2 flex list-disc flex-col gap-3 pl-5 text-zinc-100 dark:text-zinc-300/90">
              <li className="text-sm md:text-[15px]">
                Develop and maintain the Front-End of the different endpoints of
                the company’s website.
              </li>
              <li className="text-sm md:text-[15px]">
                Develop and maintain the Front-End side code to ensure that the
                user interface is properly integrated with the functionalities
                of the company’s different websites.
              </li>
              <li className="text-sm md:text-[15px]">
                Guiding teams of students during the development process of the
                different dynamics organized by the company, in order to prepare
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="relative max-w-max mx-auto mt-6 overflow-hidden rounded-lg bg-black px-32 py-6 ring-0 ring-offset-black will-change-transform focus:outline-none focus:ring-1"
        >
